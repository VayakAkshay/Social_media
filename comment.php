  ...
  <body>
        <div class="container">
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST"){
                ...
                $data = "INSERT INTO `comment` (`id`, `post_id`, `name`, `comment`) VALUES (NULL, '$id', '$username', '$comment')";
            ...
            ';
            echo '
                <form action="comment.php?post-id='.$id.'" method = "post">
                    <input type="text" placeholder = "Enter Comment" name = "comment"><br><br>
                    <button>Send</button>
                </form>';
                $datas = "SELECT * FROM `comment` WHERE post_id=$id";
